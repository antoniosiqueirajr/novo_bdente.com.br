...
class Elemailer_Widget_Video extends Widget_Base
{
	...
	{
		return esc_html__('Video', 'elemailer');
	}
	...
	protected function register_controls()
	{
		...
		$this->start_controls_section(
			'section_video',
			[
				'label' => __('Video Thumbnail', 'elemailer'),
			]
		);
		...
		$this->add_control(
			'video_type',
			[
				'label' => __('Source', 'elemailer'),
				'type' => Controls_Manager::SELECT,
				'default' => 'youtube',
				'options' => [
					'youtube' => __('YouTube', 'elemailer'),
					'vimeo' => __('Vimeo', 'elemailer'),
					'dailymotion' => __('Dailymotion', 'elemailer'),
					'hosted' => __('Self Hosted', 'elemailer'),
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'classes' => 'elementor-panel-alert elementor-control-separator-after',
				'raw' => __('Thumbnail will auto generate from the video source','elemailer'),
				'condition' => [
					'video_type!' => 'hosted',
				]
			]
