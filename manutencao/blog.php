...
<head>
    ...
    <meta name="description" content="Bdente Implantes - Especialistas em Implantes Dentários e Saúde Bucal">
    <meta name="keywords" content="implantes dentários, odontologia, saúde bucal, próteses dentárias, tratamentos odontológicos, cuidados dentários, implantodontia, estética dental, saúde dos dentes, odontologia moderna">
    <meta name="author" content="Bdente Implantes">


    <!-- Webmanifest + Favicon / App icons -->
    <link rel="manifest" href="manifest.json">
    <link rel="icon" type="image/png" href="/custom/img/bdente_icon.png" sizes="32x32">
    <link rel="apple-touch-icon" href="/custom/img/bdente_icon.png">
...
<body class="bg-secondary">
        ...
        <header class="navbar navbar-expand-lg fixed-top">
            <div class="container">
                ...
                <a class="navbar-brand pe-sm-3" href="index-2.html">
                    <img width="50%" src="/custom/img/logo.png" alt="Bdente">
                </a>
                ...
                <a class="btn btn-primary btn-sm fs-sm order-lg-3 d-none d-sm-inline-flex" href="https://api.whatsapp.com/send?phone=5541985118650&text=Oie.%20Gostaria%20de%20agendar%20uma%20avalia%C3%A7%C3%A3o%20%20%F0%9F%98%8D%20" target="_blank" rel="noopener">
                ...
                <nav class="collapse navbar-collapse" id="navbarNav">
                    <ul class="navbar-nav navbar-nav-scroll me-auto" style="--ar-scroll-height: 520px;">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="/clinicas/sobre.php">Sobre</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="/clinicas/tratamentos">Tratamentos</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="/blog.php">Blog</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="/franquias">Franquia</a>
                        </li>
                        <li class="nav-item">
                    ...
                    <div class="d-sm-none p-3 mt-n3">
                        <a class="btn btn-primary w-100 mb-1" href="https://api.whatsapp.com/send?phone=5541985118650&text=Oie.%20Gostaria%20de%20agendar%20uma%20avalia%C3%A7%C3%A3o%20%20%F0%9F%98%8D%20" target="_blank" rel="noopener">
                            <i class="ai-cart fs-xl me-2 ms-n1"></i>
                            Agende sua avaliação
                        </a>
                    </div>
                    ...
                    <div class="col-lg-7 order-lg-2 d-flex justify-content-center justify-content-lg-end mb-4 mb-md-5 mb-lg-0 pb-3 pb-md-0">
                        <div class="parallax me-lg-n4 me-xl-n5" style="max-width: 667px;">
                            <div class="parallax-layer" data-depth="0.1">
                                <img src="/custom/img/01.png" alt="Layer">
                            </div>
                            <div class="parallax-layer" data-depth="-0.2">
                                <img src="/theme/assets/img/landing/business-consulting/hero/02.png" alt="Layer">
                            </div>
                            <div class="parallax-layer" data-depth="0.25">
                                <img src="/theme/assets/img/landing/business-consulting/hero/03.png" alt="Layer">
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-5 order-lg-1">
                        <h1 class="display-3 text-center text-lg-start pb-sm-2 pb-md-3">Nº 1 em satisfação
                            de paciente</h1>
                        <p class="fs-lg text-center text-lg-start pb-xl-2 mx-auto mx-lg-0 mb-5" style="max-width: 420px;">Somos uma empresa comprometida e preocupada com a satisfação de nossos pacientes, é gratificante sermos reconhecidos pela qualidade de nossos tratamentos humanizados.</p>
                        <div class="input-group mx-auto mx-lg-0" style="max-width: 420px;">
                            <span class="input-group-text text-body-secondary">
                                <i class="ai-mail"></i>
                            </span>
                            <input class="form-control" type="phone" placeholder="Seu telefone">
                            <button class="btn btn-primary" type="button">Agende sua avaliação</button>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row row-cols-2 row-cols-md-4 g-0">
                    <div class="col d-md-flex justify-content-center text-center text-md-start position-relative">
                        ...
                        <div class="p-3 px-sm-0 py-sm-4">
                            <div class="h2 display-5 text-primary mb-0">+50 mil</div>
                            <span>Pacientes</span>
                        </div>
                    </div>
                    <div class="col d-md-flex justify-content-center text-center text-md-start position-relative">
                        ...
                        <div class="p-3 px-sm-0 py-sm-4">
                            <div class="h2 display-5 text-primary mb-0">+16</div>
                    ...
                    <div class="col d-md-flex justify-content-center text-center text-md-start position-relative">
                        <div class="position-absolute top-50 end-0 translate-middle-y border-end" style="height: 60px;"></div>
                        <div class="p-3 px-sm-0 py-sm-4">
                            <div class="h2 display-5 text-primary mb-0">+15 mil</div>
                            <span>Implantes realizados</span>
                        </div>
                    </div>
                    <div class="col d-md-flex justify-content-center text-center text-md-start position-relative">
                        <div class="p-3 px-sm-0 py-sm-4">
                            <div class="h2 display-5 text-primary mb-0">+ 20</div>
                            <span>novas unidades em 2024</span>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row pb-md-3 pb-lg-4 mb-2 mb-lg-3">
                    ...
                    <div class="col-md-5 d-flex flex-column align-items-center mb-4 mb-md-0">
                        <div class="position-relative" style="max-width: 416px;">
                            <img class="d-block position-relative z-2" src="/custom/img/ceo.png" alt="Nicolas Black">
                    ...
                    <div class="col-md-7 col-lg-6 col-xxl-5 offset-lg-1 offset-xxl-2">
                        <div class="ps-md-4 ps-lg-0">
                            ...
                            <div class="position-relative d-flex justify-content-end my-3 py-1" data-aos="fade-left" data-aos-easing="ease-out-back" data-aos-delay="500">
                                <div class="btn btn-lg btn-icon btn-primary fs-xl fw-bold rounded-circle position-absolute top-50 start-0 translate-middle-y z-2 pe-none">03</div>
                                <div class="card border-0 ps-3" style="width: calc(100% - 1.75rem);">
                                    <div class="card-body ps-4">
                            ...
                            <div class="position-relative d-flex justify-content-end my-3 py-1" data-aos="fade-left" data-aos-easing="ease-out-back" data-aos-delay="700">
                                <div class="btn btn-lg btn-icon btn-primary fs-xl fw-bold rounded-circle position-absolute top-50 start-0 translate-middle-y z-2 pe-none">04</div>
                                <div class="card border-0 ps-3" style="width: calc(100% - 1.75rem);">
                                    <div class="card-body ps-4">
                ...
                <div class="swiper-wrapper">
                    ...
                    <div class="swiper-slide">
                        <div class="card border-0 mb-4">
                            <div class="card-body">
                                <div class="d-flex align-items-center mb-3">
                                    <img class="rounded-circle" src="/theme/assets/img/avatar/22.jpg" width="60" alt="Jane Cooper">
                                    <div class="ps-3">
                        ...
                        <div class="card border-0">
                            <div class="card-body">
                                <div class="d-flex align-items-center mb-3">
                                    <img class="rounded-circle" src="/theme/assets/img/avatar/25.jpg" width="60" alt="Cameron Williamson">
                                    <div class="ps-3">
                    ...
                    <div class="swiper-slide">
                        <div class="card border-0 mb-4">
                            <div class="card-body">
                                <div class="d-flex align-items-center mb-3">
                                    <img class="rounded-circle" src="/theme/assets/img/avatar/23.jpg" width="60" alt="Wade Warren">
                                    <div class="ps-3">
                        ...
                        <div class="card border-0">
                            <div class="card-body">
                                <div class="d-flex align-items-center mb-3">
                                    <img class="rounded-circle" src="/theme/assets/img/avatar/26.jpg" width="60" alt="Leslie Alexander">
                                    <div class="ps-3">
                    ...
                    <div class="swiper-slide">
                        <div class="card border-0 mb-4">
                            <div class="card-body">
                                <div class="d-flex align-items-center mb-3">
                                    <img class="rounded-circle" src="/theme/assets/img/avatar/24.jpg" width="60" alt="Esther Howard">
                                    <div class="ps-3">
                        ...
                        <div class="card border-0">
                            <div class="card-body">
                                <div class="d-flex align-items-center mb-3">
                                    <img class="rounded-circle" src="/theme/assets/img/avatar/27.jpg" width="60" alt="Brooklyn Simmons">
                                    <div class="ps-3">
                    ...
                    <div class="swiper-slide">
                        <div class="card border-0 mb-4">
                            <div class="card-body">
                                <div class="d-flex align-items-center mb-3">
                                    <img class="rounded-circle" src="/theme/assets/img/avatar/28.jpg" width="60" alt="Fannie Summers">
                                    <div class="ps-3">
                        ...
                        <div class="card border-0">
                            <div class="card-body">
                                <div class="d-flex align-items-center mb-3">
                                    <img class="rounded-circle" src="/theme/assets/img/avatar/29.jpg" width="60" alt="Robert Fox">
                                    <div class="ps-3">
    ...
    <footer class="footer pt-lg-5 pt-4 pb-5">
        <div class="container pt-3 mt-md-2 mt-lg-3">
            ...
            <div class="nav fs-sm text-body-secondary">&copy; All rights reserved. SJR Capital <a href="https://sjrcapital.com.br/" title="Siqueira Jr" style="display: iblock; margin: 0 0 0 5px; top: 10px; position:relative;">
