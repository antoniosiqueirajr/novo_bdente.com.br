...
class Elemailer_Widget_Divider extends Widget_Base
{
	...
	{
		return esc_html__('Divider', 'elemailer');
	}
	...
	protected function register_controls()
	{
		...
		$this->add_control(
			'divider_style',
			[
				'label' => __('Divider Style', 'elemailer'),
				'type' => Controls_Manager::SELECT,
				'default' => 'solid',
				'options' => [
					'solid'  => __('Solid', 'elemailer'),
					'dashed' => __('Dashed', 'elemailer'),
					'dotted' => __('Dotted', 'elemailer'),
					'double' => __('Double', 'elemailer'),
