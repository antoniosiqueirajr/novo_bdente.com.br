<div id="mapaBrasil">
    <svg version="1.1" id="svg-map" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="100%" viewBox="0 0 450 460" enable-background="new 0 0 450 460" xml:space="preserve">
        <g>
            <a class="estado" onclick="selecionar_clinica($(this));">
            ...
            <a class="estado" onclick="selecionar_clinica($(this));">
                ...
                <text transform="matrix(1 0 0 1 411.9121 197.2689)" fill="#FFFFFF">SE</text>
            </a>
            <a class="estado" onclick="selecionar_clinica($(this));">
            ...
            <a class="estado" onclick="selecionar_clinica($(this));">
                ...
                <text transform="matrix(1 0 0 1 431.7891 182.895)" fill="#FFFFFF">AL</text>
            </a>
            <a class="estado" onclick="selecionar_clinica($(this));">
                ...
                <text transform="matrix(1 0 0 1 424.541 121.9009)" fill="#FFFFFF">RN</text>
            </a>
            <a class="estado" onclick="selecionar_clinica($(this));">
            ...
            <a class="estado" onclick="selecionar_clinica($(this));">
                ...
                <text transform="matrix(1 0 0 1 350.4648 332.6807)" fill="#FFFFFF">RJ</text>
            </a>
            <a class="estado" onclick="selecionar_clinica($(this));">
                ...
                <text transform="matrix(1 0 0 1 377.0 299.0)" fill="#FFFFFF">ES</text>
            </a>
            <a class="estado" onclick="selecionar_clinica($(this));">
                ...
                <text transform="matrix(1 0 0 1 295.4141 252.2139)" fill="#FFFFFF">DF</text>
            </a>
            <a class="estado" onclick="selecionar_clinica($(this));">
                ...
                <text transform="matrix(1 0 0 1 428.2129 147.9893)" fill="#FFFFFF">PB</text>
            </a>
        </g>
    </svg>
</div>
<style>
    ...
    #mapaBrasil .estado:hover path.circle,
    #mapaBrasil .estado:hover path{
        fill: #d71920;
    }
    #mapaBrasil .estado path{
        fill: #e6e7e8;
