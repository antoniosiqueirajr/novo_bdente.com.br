...
class CFF_Feed_Saver {
	...
	public function get_feed_settings( $is_export = false ) {
		...
		if ( $this->is_legacy ) {
            ...
            if( !in_array('photos_albums_feeds', self::$license_tier_features) || !in_array('video_feeds', self::$license_tier_features)   || !in_array('events_feeds', self::$license_tier_features)) {
