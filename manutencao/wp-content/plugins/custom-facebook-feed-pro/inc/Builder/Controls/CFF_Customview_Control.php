...
class CFF_Customview_Control extends CFF_Controls_Base{
	...
	*/
	public function get_control_feedtheme_output($controlEditingTypeModel){
		?>
		<div id="sb-control-feedtheme" :class="['sb-control-feedtype-ctn sb-control-feedtheme-ctn', 'cff-feedtheme-' + customizerScreens.printedTheme.type]" v-if="control.viewId == 'feedtheme'">
			<div class="cff-fb-type-el" v-if="customizerFeedThemePrint()"  @click.prevent.default="activateView('feedthemePopup')">
			...
			<button class="sb-control-action-button sb-btn cff-fb-fs sb-btn-grey" @click.prevent.default="activateView('feedthemePopup')">
				<div>
