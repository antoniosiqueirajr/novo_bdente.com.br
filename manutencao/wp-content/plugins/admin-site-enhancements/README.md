...
**Admin and Site Enhancements (ASE) v1.0.0** was released on October 17, 2022. Since then, there have been **60 _point_ releases** (e.g. 1.1.0 ) and **57 _patch_ releases** (e.g. 4.9.1). 
...
* **[FIXED][Free][Pro] Content Management >> Content Duplication**: fixed an issue with CSS variables used in the block editor not being properly duplicated, thus breaking the style of the duplicate post. Props to Tim H. for reporting the issue when working with blocks from GenerateBlocks.
