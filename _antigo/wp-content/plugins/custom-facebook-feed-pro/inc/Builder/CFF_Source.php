...
class CFF_Source
{
    ...
    public static function get_connection_urls($is_settings = false)
    {
        ...
        $urls['page'] = CFF_CONNECT_URL . '?wordpress_user=' . $sb_admin_email . '&vn=' . CFFVER . '&v=pro&state=';
        $urls['group'] = CFF_CONNECT_URL . '?wordpress_user=' . $sb_admin_email . '&vn=' . CFFVER . '&v=pro&state=';
