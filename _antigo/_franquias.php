...
<html lang="pt-BR" data-bs-theme="light">
    ...
    <!-- Mirrored from around.createx.studio/landing-coworking-space.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 25 Nov 2023 21:07:52 GMT -->
    ...
    <head>
        ...
        <!-- SEO meta tags -->
        <title>Bdente Implantes | Realizando sonhos implantando sorrisos!</title>
        ...
        <link rel="stylesheet" media="screen" href="/theme/assets/vendor/flatpickr/dist/flatpickr.min.css">
        <link rel="stylesheet" media="screen" href="/theme/assets/vendor/lightgallery/css/lightgallery-bundle.min.css">
        <link rel="stylesheet" media="screen" href="/theme/assets/vendor/aos/dist/aos.css">
        <link rel="stylesheet" media="screen" href="/theme/assets/vendor/leaflet/dist/leaflet.css">
    ...
    <body>
            ...
            <div class="modal-dialog modal-lg modal-dialog-scrollable" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body py-4">
                        ...
                        <p class="mb-4"><span class="fw-medium">IMPORTANT:</span> In order for these styles to take effect you have to placed them below:<br><code>&lt;link rel=&quot;stylesheet&quot; media=&quot;screen&quot; href=&quot;/theme/assets/css/theme.min.css&quot;&gt;</code></p>
        ...
        <main class="page-wrapper">
            ...
            <header class="navbar navbar-expand-lg fixed-top bg-light">
                <div class="container">
                    ...
                    <!-- Navbar brand (Logo) -->
                    <a class="navbar-brand pe-sm-3" href="index-2.html">
                                    ...
                                    <div class="d-lg-flex">
                                        <div class="mega-dropdown-column pt-1 pt-lg-3 pb-lg-4">
                                            <ul class="list-unstyled mb-0">
                                                <li>
                                                    <a class="dropdown-item" href="index-2.html">Template Intro Page</a>
                                                    <span class="mega-dropdown-column position-absolute top-0 end-0 h-100 bg-size-cover bg-repeat-0 rounded-3 rounded-start-0" style="background-image: url(/theme/assets/img/megamenu/landings.jpg);"></span>
                                                </li>
                                                <li>
                                                    <a class="dropdown-item" href="landing-mobile-app-showcase.html">Mobile App Showcase</a>
                                                    <span class="mega-dropdown-column position-absolute top-0 end-0 h-100 bg-size-cover bg-repeat-0 z-2 opacity-0" style="background-image: url(/theme/assets/img/megamenu/mobile-app.jpg);"></span>
                                                </li>
                                                <li>
                                                    <a class="dropdown-item" href="landing-product.html">Product Landing</a>
                                                    <span class="mega-dropdown-column position-absolute top-0 end-0 h-100 bg-size-cover bg-repeat-0 z-2 opacity-0" style="background-image: url(/theme/assets/img/megamenu/product-landing.jpg);"></span>
                                                </li>
                                                <li>
                                                    <a class="dropdown-item" href="landing-saas-v1.html">SaaS v.1</a>
                                                    <span class="mega-dropdown-column position-absolute top-0 end-0 h-100 bg-size-cover bg-repeat-0 z-2 opacity-0" style="background-image: url(/theme/assets/img/megamenu/saas-1.jpg);"></span>
                                                </li>
                                                <li>
                                                    <a class="dropdown-item" href="landing-saas-v2.html">SaaS v.2</a>
                                                    <span class="mega-dropdown-column position-absolute top-0 end-0 h-100 bg-size-cover bg-repeat-0 z-2 opacity-0" style="background-image: url(/theme/assets/img/megamenu/saas-2.jpg);"></span>
                                                </li>
                                                <li>
                                                    <a class="dropdown-item" href="landing-saas-v3.html">SaaS v.3</a>
                                                    <span class="mega-dropdown-column position-absolute top-0 end-0 h-100 bg-size-cover bg-repeat-0 z-2 opacity-0" style="background-image: url(/theme/assets/img/megamenu/saas-3.jpg);"></span>
                                                </li>
                                                <li>
                                                    ...
                                                    <span class="mega-dropdown-column position-absolute top-0 end-0 h-100 bg-size-cover bg-repeat-0 z-2 opacity-0" style="background-image: url(/theme/assets/img/megamenu/saas-4.jpg);"></span>
                                                </li>
                                                <li>
                                                    <a class="dropdown-item" href="landing-shop-v1.html">Shop Homepage v.1</a>
                                                    <span class="mega-dropdown-column position-absolute top-0 end-0 h-100 bg-size-cover bg-repeat-0 z-2 opacity-0" style="background-image: url(/theme/assets/img/megamenu/shop-homepage-1.jpg);"></span>
                                                </li>
                                                <li>
                                                    ...
                                                    <span class="mega-dropdown-column position-absolute top-0 end-0 h-100 bg-size-cover bg-repeat-0 z-2 opacity-0" style="background-image: url(/theme/assets/img/megamenu/shop-homepage-2.jpg);"></span>
                                                </li>
                                                <li>
                                                    <a class="dropdown-item" href="landing-marketing-agency.html">Marketing Agency</a>
                                                    <span class="mega-dropdown-column position-absolute top-0 end-0 h-100 bg-size-cover bg-repeat-0 z-2 opacity-0" style="background-image: url(/theme/assets/img/megamenu/marketing-agency.jpg);"></span>
                                                </li>
                                            </ul>
                                        </div>
                                        <div class="mega-dropdown-column pb-2 pt-lg-3 pb-lg-4">
                                            <ul class="list-unstyled mb-0">
                                                <li>
                                                    ...
                                                    <span class="mega-dropdown-column position-absolute top-0 end-0 h-100 bg-size-cover bg-repeat-0 z-2 opacity-0" style="background-image: url(/theme/assets/img/megamenu/creative-agency.jpg);"></span>
                                                </li>
                                                <li>
                                                    <a class="dropdown-item" href="landing-conference.html">Conference (Event)</a>
                                                    <span class="mega-dropdown-column position-absolute top-0 end-0 h-100 bg-size-cover bg-repeat-0 z-2 opacity-0" style="background-image: url(/theme/assets/img/megamenu/conference.jpg);"></span>
                                                </li>
                                                <li>
                                                    <a class="dropdown-item" href="landing-web-studio.html">Web Studio</a>
                                                    <span class="mega-dropdown-column position-absolute top-0 end-0 h-100 bg-size-cover bg-repeat-0 z-2 opacity-0" style="background-image: url(/theme/assets/img/megamenu/web-studio.jpg);"></span>
                                                </li>
                                                <li>
                                                    <a class="dropdown-item" href="landing-corporate.html">Corporate</a>
                                                    <span class="mega-dropdown-column position-absolute top-0 end-0 h-100 bg-size-cover bg-repeat-0 z-2 opacity-0" style="background-image: url(/theme/assets/img/megamenu/corporate.jpg);"></span>
                                                </li>
                                                <li>
                                                    ...
                                                    <span class="mega-dropdown-column position-absolute top-0 end-0 h-100 bg-size-cover bg-repeat-0 z-2 opacity-0" style="background-image: url(/theme/assets/img/megamenu/insurance.jpg);"></span>
                                                </li>
                                                <li>
                                                    <a class="dropdown-item" href="landing-business-consulting.html">Business Consulting</a>
                                                    <span class="mega-dropdown-column position-absolute top-0 end-0 h-100 bg-size-cover bg-repeat-0 z-2 opacity-0" style="background-image: url(/theme/assets/img/megamenu/business-consulting.jpg);"></span>
                                                </li>
                                                <li>
                                                    <a class="dropdown-item" href="landing-coworking-space.html">Coworking Space</a>
                                                    <span class="mega-dropdown-column position-absolute top-0 end-0 h-100 bg-size-cover bg-repeat-0 z-2 opacity-0" style="background-image: url(/theme/assets/img/megamenu/coworking.jpg);"></span>
                                                </li>
                                                <li>
                                                    <a class="dropdown-item" href="landing-yoga-studio.html">Yoga Studio</a>
                                                    <span class="mega-dropdown-column position-absolute top-0 end-0 h-100 bg-size-cover bg-repeat-0 z-2 opacity-0" style="background-image: url(/theme/assets/img/megamenu/yoga-studio.jpg);"></span>
                                                </li>
                                                <li>
                                                    <a class="dropdown-item" href="landing-influencer.html">Influencer</a>
                                                    <span class="mega-dropdown-column position-absolute top-0 end-0 h-100 bg-size-cover bg-repeat-0 z-2 opacity-0" style="background-image: url(/theme/assets/img/megamenu/influencer.jpg);"></span>
                                                </li>
                                                <li>
                                                    <a class="dropdown-item" href="landing-blog.html">Blog Homepage</a>
                                                    <span class="mega-dropdown-column position-absolute top-0 end-0 h-100 bg-size-cover bg-repeat-0 z-2 opacity-0" style="background-image: url(/theme/assets/img/megamenu/blog-homepage.jpg);"></span>
                                                </li>
                                            </ul>
                                        </div>
            ...
            <section class="pt-5">
                <div class="container position-relative z-2 pt-5 mt-3 mt-sm-4 mt-md-5">
                    <div class="row pt-xl-3 pt-xxl-4">
                        <div class="col-lg-7 col-xxl-6">
                            <h1 class="display-3 text-center text-lg-start">The best space for work and business meetings</h1>
                        </div>
                        <div class="col-lg-5 offset-xxl-1 pt-sm-3">
                            <p class="fs-lg text-center text-lg-start pb-3 pb-sm-0 pb-md-2 mb-4 mb-sm-5">Magna in purus in facilisis pretium eleifend in nullamer magna morbi eleifend vel convallis quis utrices neque tellus purus in facilisis pretium  eleifend vel convallis.</p>
                                ...
                                <form class="card-body" data-bs-theme="dark">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <div class="position-relative">
                                            <input class="form-control form-control-lg date-picker pe-5" type="text" placeholder="Choose date/time" data-datepicker-options='{"enableTime": true, "altInput": true, "altFormat": "F j, Y H:i", "dateFormat": "Y-m-d H:i"}'>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input class="form-control form-control-lg" type="email" placeholder="johnDoe@example.com" required id="email">
                                    </div>
                                    <div class="d-flex flex-column flex-sm-row flex-lg-column flex-xxl-row align-items-center justify-content-center justify-content-lg-start pt-3 pt-xxl-4">
                                        <button class="btn btn-light w-100 w-sm-auto w-lg-100 w-xxl-auto mb-2 mb-sm-0 mb-lg-2 mb-xxl-0 me-sm-3 me-lg-0 me-xxl-3" type="submit">Book space now</button>
                                        <a class="d-flex align-items-center fs-sm fw-semibold text-white text-decoration-none px-3 py-2" href="tel:+15262200459">
                ...
                <div class="jarallax" data-jarallax data-speed="0.6">
                    <div class="jarallax-img" style="background-image: url(/theme/assets/img/landing/coworking-space/parallax-image.jpg);"></div>
            ...
            <section class="container pt-5 mt-lg-3 mt-xl-4 mt-xxl-5">
                <div class="text-center pb-3 pt-2 pt-sm-3 pt-md-4 pt-xl-5 mx-auto mb-sm-2 mb-md-3 mb-lg-4" style="max-width: 525px;">
                    <h2 class="h1">About Around</h2>
                    <p class="mb-0">Enim aenean phasellus in hendrerit interdum lorem proin pretium, dictum urna suspendisse quis risus vivamus.</p>
                </div>
            ...
            <section class="container py-5 my-lg-3 my-xl-4 my-xxl-5">
                <div class="text-center pb-3 pt-sm-3 pt-md-4 mx-auto mt-xxl-1 mb-3 mb-lg-4" style="max-width: 525px;">
                    ...
                    <p class="mb-0">Morbi et massa fames ac scelerisque sit commodo dignissim faucibus vel quisque proin lectus et massa.</p>
                </div>

                <!-- Navs -->
                <ul class="nav nav-tabs flex-nowrap overflow-auto text-nowrap w-100 mx-auto pb-3 mb-3 mb-lg-4" role="tablist" style="max-width: 646px;">
                ...
                <div class="gallery row g-4 g-sm-3 g-lg-4 pb-2 pb-sm-4 pb-xl-5 mb-lg-2 mb-xl-0 mb-xxl-2">
                    <div class="col-sm-5">
                        <a class="d-block gallery-item card-hover zoom-effect" href="/theme/assets/img/landing/coworking-space/gallery/01.jpg">
                            ...
                            <div class="zoom-effect-wrapper rounded-5">
                                <img class="zoom-effect-img" src="/theme/assets/img/landing/coworking-space/gallery/th01.jpg" alt="Open space">
                            </div>
                        </a>
                    </div>
                    <div class="col-sm-7">
                        <a class="d-block gallery-item card-hover zoom-effect" href="/theme/assets/img/landing/coworking-space/gallery/02.jpg">
                            <div class="d-flex justify-content-center align-items-center position-absolute top-0 start-0 w-100 h-100 rounded-5 overflow-hidden z-2 opacity-0">
                                <i class="ai-zoom-in fs-2 text-white position-relative z-2"></i>
                                <div class="position-absolute top-0 start-0 w-100 h-100 bg-dark opacity-40"></div>
                            </div>
                            <div class="zoom-effect-wrapper rounded-5">
                                <img class="zoom-effect-img" src="/theme/assets/img/landing/coworking-space/gallery/th02.jpg" alt="Kitchen">
                            </div>
                        </a>
                    </div>
                    <div class="col-sm-4">
                        <a class="d-block gallery-item card-hover zoom-effect" href="/theme/assets/img/landing/coworking-space/gallery/03.jpg">
                            <div class="d-flex justify-content-center align-items-center position-absolute top-0 start-0 w-100 h-100 rounded-5 overflow-hidden z-2 opacity-0">
                                <i class="ai-zoom-in fs-2 text-white position-relative z-2"></i>
                                <div class="position-absolute top-0 start-0 w-100 h-100 bg-dark opacity-40"></div>
                            </div>
                            <div class="zoom-effect-wrapper rounded-5">
                                <img class="zoom-effect-img" src="/theme/assets/img/landing/coworking-space/gallery/th03.jpg" alt="Lounge zone">
                            </div>
                        </a>
                    </div>
                    <div class="col-sm-3">
                        <a class="d-block gallery-item card-hover zoom-effect" href="/theme/assets/img/landing/coworking-space/gallery/04.jpg" style="max-width: 458px;">
                            <div class="d-flex justify-content-center align-items-center position-absolute top-0 start-0 w-100 h-100 rounded-5 overflow-hidden z-2 opacity-0">
                                <i class="ai-zoom-in fs-2 text-white position-relative z-2"></i>
                                <div class="position-absolute top-0 start-0 w-100 h-100 bg-dark opacity-40"></div>
                            </div>
                            <div class="zoom-effect-wrapper rounded-5">
                                <img class="zoom-effect-img" src="/theme/assets/img/landing/coworking-space/gallery/th04.jpg" alt="Open space">
                            </div>
                        </a>
                    </div>
                    <div class="col-sm-5">
                        <a class="d-block gallery-item card-hover zoom-effect" href="/theme/assets/img/landing/coworking-space/gallery/05.jpg">
                            <div class="d-flex justify-content-center align-items-center position-absolute top-0 start-0 w-100 h-100 rounded-5 overflow-hidden z-2 opacity-0">
                                <i class="ai-zoom-in fs-2 text-white position-relative z-2"></i>
                                <div class="position-absolute top-0 start-0 w-100 h-100 bg-dark opacity-40"></div>
                            </div>
                            <div class="zoom-effect-wrapper rounded-5"><img class="zoom-effect-img" src="/theme/assets/img/landing/coworking-space/gallery/th05.jpg" alt="Cafe"></div>
                        </a>
                    </div>
                </div>
            </section>
            ...
            <section class="bg-secondary py-5">
                <div class="container py-lg-3 py-xl-4 py-xxl-5">
                    <h2 class="h1 text-center pt-1 pt-sm-3 pt-md-4 pb-3 pb-sm-4 pb-lg-5">Why choose Around as a coworking space</h2>
                    <div class="row align-items-center pb-5 mb-2 mb-md-3 mb-lg-4 mb-xl-5" data-aos="fade-up" data-aos-duration="600" data-aos-offset="300" data-disable-parallax-down="md">
                        <div class="col-md-6 pb-1 pb-sm-3 pb-md-0 mb-4 mb-md-0">
                            <img class="d-block rounded-5 mx-auto" src="/theme/assets/img/landing/coworking-space/features/01.jpg" width="470" alt="Image">
                        </div>
                        <div class="col-md-6 col-lg-5 col-xl-4 offset-lg-1" data-aos="fade-up" data-aos-duration="850" data-aos-offset="200" data-disable-parallax-down="md">
                            <div class="ps-md-4 ps-lg-0">
                                <h3 class="h2 pb-md-2 pb-lg-3">Fixed workplace when buying a monthly pass</h3>
                                <p class="mb-4 pb-md-2 pb-lg-0 mb-lg-5">Morbi et massa fames ac scelerisque sit commodo dignissim aucibus vel quisque proin lectus laoreet adipiscing sollicitudin erat massa tellus lorem.</p>
                    ...
                    <div class="row align-items-center pb-5 mb-2 mb-md-3 mb-lg-4 mb-xl-5" data-aos="fade-up" data-aos-duration="600" data-aos-offset="300" data-disable-parallax-down="md">
                        <div class="col-md-6 pb-1 pb-sm-3 pb-md-0 mb-4 mb-md-0">
                            <div class="position-relative overflow-hidden mx-auto" style="max-width: 503px;">
                                <img class="position-relative z-2" src="/theme/assets/img/landing/coworking-space/features/02.png" alt="Image">
                                <img class="position-absolute top-0 start-0 d-dark-mode-none" src="/theme/assets/img/landing/coworking-space/features/circles-dark.png" alt="Image" style="animation: rotate-cw 60s linear infinite;">
                                <img class="position-absolute top-0 start-0 d-none d-dark-mode-block" src="/theme/assets/img/landing/coworking-space/features/circles-light.png" alt="Image" style="animation: rotate-cw 60s linear infinite;">
                            </div>
                        </div>
                        <div class="col-md-6 col-lg-5 col-xl-4 offset-lg-1" data-aos="fade-up" data-aos-duration="850" data-aos-offset="200" data-disable-parallax-down="md">
                            <div class="ps-md-4 ps-lg-0">
                                <h3 class="h2 pb-md-2 pb-lg-3">Buy passes for a team of 5 or more members with a <span class="text-danger">20% discount</span></h3>
                                <p class="mb-0">Scelerisque et massa fames ac morbi sit commodo dignissim aucibus vel quisque proin lectus laoreet sem adipiscing sollicitudin erat massa tellus lorem aenean phasellus in hendrerit interdum lorem proin pretium, dictum urna suspendisse quis risus.</p>
                            </div>
                        </div>
                    </div>
                    <div class="row align-items-center pb-2 pb-sm-4 pb-lg-5" data-aos="fade-up" data-aos-duration="600" data-aos-offset="300" data-disable-parallax-down="md">
                        <div class="col-md-6 pb-1 pb-sm-3 pb-md-0 mb-4 mb-md-0">
                            <img class="d-block rounded-5 mx-auto" src="/theme/assets/img/landing/coworking-space/features/03.jpg" width="470" alt="Image">
                        </div>
                        <div class="col-md-6 col-lg-5 col-xl-4 offset-lg-1" data-aos="fade-up" data-aos-duration="850" data-aos-offset="200" data-disable-parallax-down="md">
                            <div class="ps-md-4 ps-lg-0">
                                <h3 class="h2 pb-md-2 pb-lg-3">Private fully equipped halls for online meetings and conferences</h3>
            ...
            <section class="container pt-5 mt-lg-3 mt-xl-4 mt-xxl-5">
                <div class="row text-center text-md-start pb-3 pt-1 pt-sm-3 pt-md-4 pt-xl-5 mt-lg-2 mt-xl-0 mb-3 mb-lg-4">
                    ...
                    <div class="col-md-6 pt-2">
                        <p class="mb-0">Morbi et massa fames ac scelerisque sit commodo dignissim aucibus vel quisque proin lectus laoreet sem adipiscing sollicitudin erat massa tellus lorem aenean.</p>
                    </div>
                </div>
                <div class="rounded-5 overflow-hidden">   
                    <div class="jarallax ratio ratio-16x9 d-flex align-items-center justify-content-center" data-jarallax data-speed="0.6">
                        ...
                        <div class="w-auto position-relative p-4">
                            <a class="btn btn-icon btn-xl btn-primary rounded-circle stretched-link" href="https://www.youtube.com/watch?v=IxRVa1DbSAg" data-bs-toggle="video" aria-label="Play video">
            ...
            <section class="container pt-5 mt-1 mt-sm-2 mt-lg-4 mt-xxl-5">
                <div class="row align-items-center pt-2 pt-sm-3 pt-md-4 pt-xl-5 mt-xxl-2">
                    ...
                    <div class="col-md-5 col-xl-4 offset-lg-1 mt-0 mt-md-n5 mb-5 mb-md-0">
                        <div class="pe-md-4">
                            <h2 class="h1 text-center text-md-start mb-4">More than 2,000 clients use Around as a work space</h2>
                    ...
                    <div class="col-md-7 col-lg-6">
                                ...
                                <div class="swiper" data-swiper-options='
                                    ...
                                    <div class="swiper-wrapper">
                                        ...
                                        <div class="swiper-slide">
                                            <p class="lead text-dark pb-3 mb-3">"Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed et tempus erat, a vulputate dui. Orci varius natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus. Ut luctus molestie massa sit amet dapibus. Cras pulvinar lacinia sollicitudin malesuada vestibulum."</p>
                                            <div class="d-flex align-items-center">
                                                <img class="rounded-circle" src="/theme/assets/img/avatar/30.jpg" width="60" alt="Jenny Wilson">
                                                <div class="ps-3">
                                        ...
                                        <div class="swiper-slide">
                                            ...
                                            <div class="d-flex align-items-center">
                                                <img class="rounded-circle" src="/theme/assets/img/avatar/31.jpg" width="60" alt="Esther Howard">
                                                <div class="ps-3">
                                        ...
                                        <div class="swiper-slide">
                                            ...
                                            <div class="d-flex align-items-center">
                                                <img class="rounded-circle" src="/theme/assets/img/avatar/32.jpg" width="60" alt="Nick Wenirten">
                                                <div class="ps-3">
                        ...
                        <div class="d-flex justify-content-center justify-content-md-start pt-4">
                            ...
                            <button class="btn btn-icon btn-sm btn-outline-primary rounded-circle" type="button" id="next-testimonial" aria-label="Next">
                    ...
                    <div class="position-relative z-5 ms-lg-5" style="max-width: 530px;">
                        <div class="card border-0">
                            <div class="card-body">
                                ...
                                </div><a href="milto:email@xample.com">email@xample.com</a>
                            </div>
                        </div>
                    </div>
                    <div class="d-none d-xxl-block" style="height: 160px;"></div>
        ...
        <script src="/theme/assets/vendor/flatpickr/dist/flatpickr.min.js"></script>
        <script src="/theme/assets/vendor/swiper/swiper-bundle.min.js"></script>
        <script src="/theme/assets/vendor/lightgallery/lightgallery.min.js"></script>
        <script src="/theme/assets/vendor/lightgallery/plugins/video/lg-video.min.js"></script>
        <script src="/theme/assets/vendor/lightgallery/plugins/fullscreen/lg-fullscreen.min.js"></script>
        <script src="/theme/assets/vendor/lightgallery/plugins/zoom/lg-zoom.min.js"></script>
        <script src="/theme/assets/vendor/lightgallery/plugins/thumbnail/lg-thumbnail.min.js"></script>
        <script src="/theme/assets/vendor/aos/dist/aos.js"></script>
        <script src="/theme/assets/vendor/leaflet/dist/leaflet.js"></script>
    ...
    <!-- Mirrored from around.createx.studio/landing-coworking-space.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 25 Nov 2023 21:07:56 GMT -->
</html>
