...
<head>
    ...
    <!-- Viewport -->
    <meta name="keywords" content="implantes dentários, odontologia, saúde bucal, próteses dentárias, tratamentos odontológicos, cuidados dentários, estética dental, saúde dos dentes, implantodontia, sorriso saudável, clínica odontológica, dentista, prótese fixa, prótese removível, cirurgia oral, restauração dentária, periodontia, higiene bucal, check-up odontológico">
    <meta name="viewport" content="width=device-width, initial-scale=1, minimum-scale=1, maximum-scale=1, viewport-fit=cover">

    <!-- SEO meta tags -->
    <title>Bdente Implantes | Realizando sonhos implantando sorrisos!</title>
    <meta name="description" content="Bdente Implantes">
    <meta name="author" content="SJR Capital - It Outsourcing">
    ...
    <!-- Google tag (gtag.js) -->
    <script async src="https://www.googletagmanager.com/gtag/js?id=G-NFS13BYBHF"></script>
    <script>
...
<body class="bdente">
    ...
    <noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-K2ZXB5XH" height="0" width="0" style="display:none;visibility:hidden"></iframe></noscript>
    ...
    <main class="page-wrapper">
        <div class="d-lg-flex position-relative h-100">
            ...
            <div class="d-flex d-lg-none justify-content-center pt-4 px-3 mx-auto" style="max-width: 420px;">
                <a class="navbar-brand text-dark p-0 m-0" href="index-2.html">
                    <img width="20%" src="/custom/img/logo-de-natal.png" alt="Bdente Implantes">
                </a>
            </div>
                    ...
                    <div class="position-relative h-100">
                        ...
                        <div class="parallax h-100 z-2 overflow-hidden">
                            <div class="parallax-layer d-flex align-items-end mb-n2 mb-lg-0" style="margin-top: 4.4%;" data-depth="0.1">
                                <img src="/custom/img/drJulioCS.png" alt="Julio Pereira">
                            </div>
                        </div>
            ...
            <div class="d-flex flex-column align-items-center w-lg-50 px-3 px-sm-4 px-xl-5 pt-lg-5 order-lg-1">
                ...
                <div class="w-100 d-none d-lg-block" style="max-width: 420px;">
                    <img src="/custom/img/logo-de-natal.png" alt="Bdente" style="max-height: 70px;">
                </div>

                <!-- Text + Countdown + Form -->
                <div class="w-100 text-center text-lg-start mt-auto pt-lg-5 pb-5" style="max-width: 420px;">
                    <h1 class="display-3 mb-4 lh-1">Estamos em manutenção</h1>
                    ...
                    <!-- Countdown -->
                    <div class="countdown d-flex flex-wrap justify-content-center justify-content-lg-start pb-3 mb-4 mb-xl-5" data-countdown-date="01/03/2024 00:00:00">
                        <div class="text-center mb-2">
                            <div class="bg-secondary rounded-1 p-2">
                                <div class="h3 fw-medium mb-0 mx-1" data-days></div>
                            </div>
                            <span class="fs-sm">Dias</span>
                        </div>
                        ...
                        <div class="text-center mb-2">
                            ...
                            <span class="fs-sm">Segundos</span>
                        </div>
                    </div>
                ...
                <div class="w-100 mt-auto pb-5" style="max-width: 420px;">
                    <div class="d-flex justify-content-center justify-content-lg-start gap-3">
                        <a class="btn btn-icon btn-sm btn-secondary btn-facebook rounded-circle" href="https://facebook.com/bdenteimplantes" aria-label="Facebook">
                            <i class="ai-facebook"></i>
                        </a>
                        <a class="btn btn-icon btn-sm btn-secondary btn-instagram rounded-circle" href="https://www.instagram.com/bdenteimplantes/" aria-label="Instagram">
                            <i class="ai-instagram"></i>
                        </a>
                        <a class="btn btn-icon btn-sm btn-secondary btn-linkedin rounded-circle" href="https://br.linkedin.com/bdenteimplantes" aria-label="LinkedIn">
    ...
    <script src="/theme/assets/vendor/timezz/dist/timezz.js"></script>
