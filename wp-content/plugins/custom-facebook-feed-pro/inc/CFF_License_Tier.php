...
class CFF_License_Tier extends License_Tier
{
    ...
    public $item_id_basic = 210; // put item id for the basic tier
    public $item_id_plus = 299; // put item id for the plus tier
    public $item_id_elite = 300; // put item id for the elite tier
